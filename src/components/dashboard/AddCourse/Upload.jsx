  ...
  return (
    <div className="flex flex-col space-y-2 overflow-hidden">
      ...
      <div
        ...
        className={`${isDragActive ? "bg-[#424854]" : "bg-[#2C333F]"
          } flex min-h-[250px] items-center justify-center rounded-md border-2 border-dotted border-[#585D69] overflow-hidden ${previewSource ? "cursor-default" : "cursor-pointer"
          }`}
      >
