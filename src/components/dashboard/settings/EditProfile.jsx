  ...
  return (
    ...
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        {/* Profile Information */}
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-[#2C333F] bg-[#161D29] p-8 px-12 text-white">
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              >
                {genders.map((ele, i) => {
                  return (
                    <option key={i} value={ele} className="text-black">
                      {ele}
                    </option>
                  )
                })}
