  ...
  return (
    <>
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-[#2C333F] bg-[#161D29] p-8 px-12">
        ...
        >
          {user?.additionalsDetails?.about ?? "Write Something About Yourself"}
        </p>
      </div>
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-[#2C333F] bg-[#161D29] p-8 px-12">
        <div className="flex w-full items-center justify-between">
        ...
        <div className="flex max-w-[500px] justify-between">
          <div className="flex flex-col gap-y-5">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-[#F1F2FF]">
                {user?.additionalsDetails?.gender ?? "Add Gender"}
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-y-5">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-[#F1F2FF]">
                {user?.additionalsDetails?.contactNumber ?? "Add Contact Number"}
              </p>
            </div>
            <div>
              <p className="mb-2 text-sm text-[#424854]">Date Of Birth</p>
              <p className="text-sm font-medium text-[#F1F2FF]">
                {formattedDate(user?.additionalsDetails?.dateOfBirth) ??
                  "Add Date Of Birth"}
              </p>
            </div>
          </div>
